...
window.CKEditor = __webpack_require__(/*! ckeditor4-vue */ "./node_modules/ckeditor4-vue/dist/ckeditor.js");
/**
...
Vue.component('example-component', Object(function webpackMissingModule() { var e = new Error("Cannot find module './components/ExampleComponent.vue'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())); // Vue.component('Dataset', Dataset)
...
var app = new Vue({
  ...
  methods: {
    // ckeditor() {
    // },
    sendForm: function sendForm() {// axios.post('admin/posts', this.editorData)
      //     .then(() => {
